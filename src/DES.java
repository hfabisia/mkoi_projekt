...
class DES {
  ...
  public static String finalOutput(String data, String key1){
    String input = data;
...
//    System.out.println("\n+++ ENCRYPTION +++");
    ...
    String a = IntArrayToString(outputBits);
    return binToHex(a);

//    return  Arrays.toString(permute(inputBits, keyBits, false));
//		System.out.println("\n+++ DECRYPTION +++");
...
>>>>>>> 03b779d205dfe1b37efa7da4826dd66edc109517
}